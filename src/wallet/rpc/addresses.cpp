                    ...
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::OBJ, "embedded", /*optional=*/true, "Information about the address embedded in P2SH or P2WSH, if relevant and known.",
                        {
                            {RPCResult::Type::STR, "address", /*optional=*/true, "The bitcoin address of the embedded script.", {},
                                {.print_elision=std::string{"Includes all getaddressinfo output fields for the embedded address, excluding metadata (timestamp, hdkeypath, hdseedid)\n"
                                "and relation to the wallet (ismine)."}}},
                            {RPCResult::Type::STR_HEX, "scriptPubKey", /*optional=*/true, "The hex-encoded output script generated by the address.", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::BOOL, "isscript", /*optional=*/true, "If the key is a script.", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::BOOL, "iswitness", /*optional=*/true, "If the address is a witness address.", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::NUM, "witness_version", /*optional=*/true, "The version number of the witness program.", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::STR_HEX, "witness_program", /*optional=*/true, "The hex value of the witness program.", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::STR, "script", /*optional=*/true, "The output script type. Only if isscript is true and the redeemscript is known. Possible\n"
                                                                         "types: nonstandard, pubkey, pubkeyhash, scripthash, multisig, nulldata, witness_v0_keyhash,\n"
                                "witness_v0_scripthash, witness_unknown.", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::STR_HEX, "hex", /*optional=*/true, "The redeemscript for the p2sh address.", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::ARR, "pubkeys", /*optional=*/true, "Array of pubkeys associated with the known redeemscript (only if script is multisig).",
                            {
                                {RPCResult::Type::STR, "pubkey", ""},
                            }, {.print_elision=std::string{""}}},
                            {RPCResult::Type::NUM, "sigsrequired", /*optional=*/true, "The number of signatures required to spend multisig output (only if script is multisig).", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::STR_HEX, "pubkey", /*optional=*/true, "The hex value of the raw public key for single-key addresses (possibly embedded in P2SH or P2WSH).", {}, {.print_elision=std::string{""}}},
                            {RPCResult::Type::OBJ, "embedded", /*optional=*/true, "Further information about the address embedded in P2SH or P2WSH, if relevant and known.",
                                {}, {.skip_type_check=true, .print_elision=std::string{""}}},
                            {RPCResult::Type::BOOL, "iscompressed", /*optional=*/true, "If the pubkey is compressed.", {}, {.print_elision=std::string{""}}},
                        }},
